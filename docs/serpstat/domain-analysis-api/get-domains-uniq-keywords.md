...
Should be exact `SerpstatDomainProcedure.getDomainsUniqKeywords`
...
```bash
curl --request POST \
  --url 'https://api.serpstat.com/v4/?token=123#SerpstatDomainProcedure.getDomainsUniqKeywords' \
    ...
    "data": [
      {
        ...
        "keyword": "best way to clean shoes",
        "keyword_length": 5,
        "url": "https://www.nike.com/a/how-to-clean-shoes",
        "position": 1,
        "date": "2025-01-28",
        "types": [
          "related_search",
        ...
        "found_results": 326000000,
        "cost": 0.9299999999999999,
        "concurrency": 93,
      ...
      },
      {
        "domain": "nike.com",
        "subdomain": "www.nike.com",
        "keyword": "5 inch nike shorts",
        "keyword_length": 4,
        "url": "https://www.nike.com/w/mens-running-shorts-37v7jz38fphznik1",
        "position": 1,
        "date": "2025-01-29",
        "types": [
          "related_search",
