...
The `SerpstatDomainProcedure.getTopUrls` method returns website pages that rank for the largest amount of the analyzed keyword variations and have the highest traffic. The data set is similar to the Top pages report of the Keyword Analysis.
    ...
    "data": [
      {
        ...
        "organic_keywords": 121054,
        "facebook_shares": 806,
        "potencial_traff": 326701
      },
      {
        "url": "https://www.nike.com/retail",
        "organic_keywords": 51949,
        "facebook_shares": 28525,
        "potencial_traff": 2087312
      },
      {
        "url": "https://www.nike.com/",
        "organic_keywords": 45360,
        "facebook_shares": 892623,
        "potencial_traff": 3361668
      }
    ],
    "summary_info": {
      "page": 1,
...
| result.data | array[object] | Yes | Array containing URL information objects |
...
| organic_keywords | integer | Number of organic keywords the URL ranks for |
| facebook_shares | integer | Number of Facebook shares for the URL |
| potencial_traff | integer | Potential traffic estimate for the URL |
...
```bash
curl --request POST \
  --url 'https://api.serpstat.com/v4/?token=123#SerpstatDomainProcedure.getTopUrls' \
