ocs/serpstat/10-project-management-api.md</path>
...
The Project Management API provides the following methods:

1. [`create-project`](docs/serpstat/project-management-api/create-project.md) - Create a new project
2. [`delete-project`](docs/serpstat/project-management-api/delete-project.md) - Delete an existing project  
3. [`get-projects`](docs/serpstat/project-management-api/get-projects.md) - Retrieve project information

### Data Schemas

- [`ID Schema`](docs/serpstat/project-management-api/schemas/id.md) - ID schema documentation
