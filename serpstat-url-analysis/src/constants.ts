/**
 * Serpstat URL Analysis API Constants
 * ====================================
 *
 * This file contains all the API method names and constants used by the
 * Serpstat URL Analysis MCP server. All method names are case-sensitive
...
/**
 * Search Engine Codes
 * List of supported search engines for URL analysis
 */
export const SEARCH_ENGINES = [
  ...
  'g_cl', 'g_cn', 'g_cx', 'g_сс', 'g_co', 'g_km', 'g_ck', 'g_cr', 'g_ci', 'g_hr',
...
/**
 * Output Data Options for getSummaryTraffic
 */
export const OUTPUT_DATA_OPTIONS = ['traffic', 'keywords'] as const;